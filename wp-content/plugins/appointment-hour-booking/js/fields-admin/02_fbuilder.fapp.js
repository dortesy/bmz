	...
	$.fbuilder.controls[ 'ffields' ].prototype,
	{
		...
		editItemEvents:function()
		{
			...
			var evt = [
				...
				{s:"#sInvalidDates",e:"keyup", l:"invalidDates"},
		...
		{    
            ...
            str += '<div id="sdInvalidDates"><label>Invalid Dates [<a class="helpfbuilder" text="To define some dates as invalid, enter the dates with the format: mm/dd/yyyy separated by comma; for example: 12/31/2014,02/20/2014 or by hyphen for intervals; for example: 12/20/2014-12/28/2014 ">help?</a>]</label><br /><textarea class="large" name="sInvalidDates" id="sInvalidDates" />'+$.fbuilder.htmlEncode(this.invalidDates)+'</textarea></div>';
