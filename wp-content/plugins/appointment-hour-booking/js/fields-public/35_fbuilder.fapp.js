				    ...
				    total = total.toFixed(2);
		  			...
		  			$( '.slotsCalendar' + me.name + ' .slots a').off("click").on("click", function() 
		  			{
						...
						if($(this).parent().hasClass('currentSelection')){
							    var dateInfoDay = $(this).parent().parent().attr("d");
								var dateInfoh1 = $(this).parent().attr("h1");
								var dateInfoh2 = $(this).parent().attr("h2");
								console.log(dateInfoDay);
								console.log(dateInfoh1);
								console.log(dateInfoh2);

								//console.log($(this).parent());
								var cancelButton = $( `.ahb_list[d="${dateInfoDay}"][h1="${dateInfoh1}"][h2="${dateInfoh2}"] a.cancel`)
								var d = $(cancelButton).parents(".ahb_list").attr("d");
								var h1 = $(cancelButton).parents(".ahb_list").attr("h1");
								var m1 = $(cancelButton).parents(".ahb_list").attr("m1");
								var h2 = $(cancelButton).parents(".ahb_list").attr("h2");
								var m2 = $(cancelButton).parents(".ahb_list").attr("m2");
								var s = $(cancelButton).parents(".ahb_list").attr("s");
								me.usedSlots[d] = me.usedSlots[d] || [];
								var find = false;
